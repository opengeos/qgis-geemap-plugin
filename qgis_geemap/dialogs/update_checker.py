"""
Update Checker Dialog for QGIS Geemap
...
class DownloadWorker(QThread):
    ...
    def run(self):
        ...
        try:
            ...
            temp_dir = tempfile.mkdtemp(prefix="qgis_geemap_update_")
            ...
            for root, dirs, files in os.walk(extract_dir):
                if "metadata.txt" in files and "qgis_geemap.py" in files:
            ...
            try:
                ...
                def is_valid_plugin_dir(path):
                    ...
                    ) and os.path.exists(os.path.join(path, "qgis_geemap.py"))
...
class UpdateCheckerDialog(QDialog):
    ...
    def __init__(self, plugin_dir, parent=None):
        ...
        self.setWindowTitle("QGIS Geemap Update")
    ...
    def _setup_ui(self):
        ...
        # Header
        header_label = QLabel("QGIS Geemap Update Checker")
        header_font = QFont()
    ...
    def _on_download_finished(self, install_path):
        ...
        QMessageBox.information(
            self,
            "Update Complete",
            f"QGIS Geemap has been updated to version {self.latest_version}.\n\n"
