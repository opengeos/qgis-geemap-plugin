"""
Python Standalone Manager for QGIS Geemap Plugin.
...
CACHE_DIR = os.path.expanduser("~/.qgis_geemap")
...
def _log(message, level=Qgis.Info):
    ...
    """
    QgsMessageLog.logMessage(str(message), "Geemap", level=level)
...
def verify_standalone_python():
    ...
    try:
        ...
        # python_path is a path the plugin manages itself (a downloaded
        # python-build-standalone interpreter); argv is fully fixed.
