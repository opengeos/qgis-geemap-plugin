...
the plugin's Python dependencies (geemap, earthengine-api) without
...
def _get_verification_code(package_name):
    ...
    elif package_name == "geemap":
        return "import geemap; print(geemap.__version__)"
